                        ...
                        <div className='upload-section'>
                            ...
                            {resumeFile && (
                                <div className='resume-selected'>
                                    ...
                                    <div className='resume-selected__file'>

                                        <span className='resume-selected__icon'>
                                            {resumeFile.type === 'application/pdf'
                                                ? 'PDF'
                                                : 'DOCX'}
                                        </span>

                                        <div className='resume-selected__details'>

                                            <p className='resume-selected__name'>
                                                {resumeFile.name}
                                            </p>

                                            <p className='resume-selected__size'>
